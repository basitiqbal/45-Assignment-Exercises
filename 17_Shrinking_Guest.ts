...
let guestList: string[] = ["Moiz", "Farooq", "Danish","Sarim","Muhib","Jujjan"];
...
//using while loop to remove guest from the array until only 2 names remain
while (guestList.length>2) {
let removeGuest=guestList.pop();
console.log(`SORRY ${removeGuest}, You are not invvited.`)
}
console.log(`InvitatioN to the last two guests`);
guestList.forEach(lastTwo=> console.log(`Great! ${lastTwo} You are invited to dinner.`));
